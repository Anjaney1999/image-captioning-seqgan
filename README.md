...
* Place images from flickr8k, flickr30, or coco within the images folder (make sure to place it in the correct subdirectory). For mscoco, place the train2014 and val2014 folders as is into the correct image folder
* Run preprocess.py
* Run train_mle.py
